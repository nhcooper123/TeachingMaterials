...
- Mapping species distributions (*SDMs*)
- Biodiversity indices (*Today*)
- Phylogenetic comparative methods (*Monday*)
- Large databases e.g. PREDICTS (*Andy*)
- Models, simulations etc.
- Increasingly field work (*Nate Sanders, Sally Keith*)
...
- Citizen Science
- Data availability, charing, reproducibility
