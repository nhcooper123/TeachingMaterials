...
Note that now we have the average for each landmark as a large black point, and the aligned landmarks for each specimen scattered around these in grey.
...
It is a little harder to read than Zelditch, but more focused on practical analysis. 
